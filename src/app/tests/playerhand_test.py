...
class Test(UTParent):
    ...
    def test_is_suited_but_not_connected(self):
        hand = PlayerHand()
        hand.add_hole_card(self.get_ace_diamonds())
        hand.add_hole_card(self.get_six_diamonds())
        
        assert False == hand.is_connected_and_suited()
        
    def test_is_not_suited_but_is_connected(self):
        hand = PlayerHand()
        hand.add_hole_card(self.get_king_diamonds())
        hand.add_hole_card(self.get_ace_hearts())
    ...
    def test_is_connected_and_suited(self): 
        hand = PlayerHand()
        hand.add_hole_card(self.get_king_diamonds())
        hand.add_hole_card(self.get_ace_diamonds())
    ...
    def test_is_seven_two(self):
        hand = PlayerHand()  
        hand.add_hole_card(self.get_seven_clubs())  
        hand.add_hole_card(self.get_two_diamonds())
         
        assert True == hand.is_seven_two()         

    def test_is_not_seven_two(self):
        hand = PlayerHand()  
        hand.add_hole_card(self.get_ace_clubs())  
        hand.add_hole_card(self.get_two_diamonds())
         
        assert False == hand.is_seven_two()  
